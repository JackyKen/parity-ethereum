...
use full_sync::sync_io::SyncIo;
use super::{WarpSync, SyncConfig};
use full_sync::block_sync::{BlockDownloader, BlockDownloaderImportError as DownloaderImportError};
use rand::Rng;
use full_sync::snapshot::{Snapshot};
use full_sync::{EthProtocolInfo as PeerInfoDigest, WARP_SYNC_PROTOCOL_ID};
use full_sync::private_tx::PrivateTxHandler;
use full_sync::transactions_stats::{TransactionsStats, Stats as TransactionStats};
...
pub mod tests {
	...
	use full_sync::private_tx::NoopPrivateTxHandler;
